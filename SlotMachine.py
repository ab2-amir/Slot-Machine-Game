...
pygame.display.set_caption("Slot Machine Game @Ab Amir TV")
...
while run:
    ...
    # Print the price of 1 ticket
    ticket = police_menu.render("X1   -15$ ", True, (250, 0, 0))
    screen.blit(ticket, (170, 405))

    # Draw icon image
    Locations.draw(screen)
    # Draw icon image for menu
